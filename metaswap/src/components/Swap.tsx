...
export const Swap: React.FC = () => {
    const TOKEN_ADDRESSES = {
        SDT: '0xe11F49247CD6Aa1DaCE0CAeA337edae1f1E37299',
        SKT: '0x822f6e19aa43f20989c0627C2740332583Fa1d3d',
    };

    const TOKENSWAP_CONTRACT_ADDRESS = '0xE98835B94B6A5E085991CBfeAe8676E33FC54827';
